...
dotfiles remote add origin https://github.com/Franjly/dotfiles.git
```
...
```
git clone --separate-git-dir=$HOME/.dotfiles https://github.com/Franjly/dotfiles.git $HOME/tmpdotfiles
